...
private:
    ...
    UserCategory(const std::string&, UserCategory *parent = nullptr, const std::string &domain = std::string());
    ~UserCategory();
public:
    const std::string &name(bool i18n = false) const { return i18n ? m_i18n : m_name; }
    UserCategory *parent() const { return m_parent;}

    UserCategory *createChild(const std::string&, const std::string &domain = std::string());
...
public:
    static UserCategory *newCategory(const std::string&, UserCategory* parent = nullptr, const std::string &domain = std::string());
    ...
    static UserCategory *createRoot(const std::string&, const std::string &domain = std::string());
